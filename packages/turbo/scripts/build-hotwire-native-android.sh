...
# Downgrade kotlin-reflect to match the project used kotlin version
sed -i '' 's/org\.jetbrains\.kotlin:kotlin-reflect:2\.1\.0/org.jetbrains.kotlin:kotlin-reflect:1.9.10/g' $DEPENDENCIES_GRADLE_FILE
