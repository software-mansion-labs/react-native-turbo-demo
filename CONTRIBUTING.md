...
While developing, you can run the [example app](/examples/turbo-demo-expo-example/README.md) to test your changes. Any changes you make in your library's JavaScript code will be reflected in the example app without a rebuild. If you change any native code, then you'll need to rebuild the example app.
